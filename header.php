...
<nav class="navbar navbar-inverse">
	<div class="container-fluid">
		<div class="navbar-header">
			...
			<!-- Site name -->
			<a href="index.php" class="navbar-brand">Center Bound</a>
		</div>
		<div class="collapse navbar-collapse" id="myNav">
			...
			<?php
				if(isset($_SESSION['userId'])){
					echo '<ul class="nav navbar-nav navbar-right"><li><a href="#"><button type="submit" name="logout_submit" class="logout_btn"><span class="glyphicon glyphicon-log-out"></span> Logout</button></a></li></ul>';
				}else{
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<form class="text-center" method="post" action="includes/signin.inc.php">
						...
						<input type="password" name="password" id="signin_password" class="signin_password form-control mb-4" placeholder="Password">
